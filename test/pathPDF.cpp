...
int main() {
    ...
    auto pdfs = compute_strategy_pdfs(cp, cl, 5, 1);
    ...
    // auto pdfs = compute_strategy_pdfs(cp, cl, 4, 2);
    ...
    // p.x = Vec3(4.0f,2.0f,0.0f); p.N = Vec3(0.0f,1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // p.x = Vec3(3.0f,5.0f,0.0f); p.N = Vec3(0.0f,-1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // p.x = Vec3(2.0f,1.0f,0.0f); p.N = Vec3(0.0f,1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // auto pdfs = compute_strategy_pdfs(cp, cl, 2, 4);
    ...
    // p.x = Vec3(3.0f,5.0f,0.0f); p.N = Vec3(0.0f,-1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // p.x = Vec3(2.0f,1.0f,0.0f); p.N = Vec3(0.0f,1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // p.x = Vec3(1.0f,2.0f,0.0f); p.N = Vec3(0.0f,-1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // auto pdfs = compute_strategy_pdfs(cp, cl, 1, 5);
    ...
    // p.x = Vec3(2.0f,1.0f,0.0f); p.N = Vec3(0.0f,1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // p.x = Vec3(1.0f,2.0f,0.0f); p.N = Vec3(0.0f,-1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<LambertBRDF>(Vec3(0.8f,0.0f,0.0f));cl.push_back(p);
    // p.x = Vec3(0.0f,0.0f,0.0f); p.N = Vec3(0.0f,1.0f,0.0f); p.pdf_A = 1.0f; p.pdf_W = 1.0f; p.pdf_rev = 1.0f; p.brdf = std::make_shared<Sensor>(); cl.push_back(p);
    // auto pdfs = compute_strategy_pdfs(cp, cl, 0, 6);
