...
Camera controll_scene(const int w, const int h, std::vector<std::shared_ptr<Object>>& scene) {
    ...
    Camera camera(Vec3(0, 0, -1), Vec3(0, 0, 1), Vec3(0, 1, 0), 90.0f, aspect, w, h);
    ...
    // auto white = std::make_shared<LambertBRDF>(Vec3(0.5f, 0.5f, 0.5f));
    ...
    // scene.push_back(std::make_shared<Rectangle>(Vec3(0, -1, 0), Vec3(0, 0, 1), Vec3(1, 0, 0), white));
    ...
    // scene.push_back(std::make_shared<Rectangle>(Vec3(-1, 0, 0), Vec3(0, 1, 0), Vec3(0, 0, 1), white));
    // scene.push_back(std::make_shared<Rectangle>(Vec3(1, 0, 0), Vec3(0, 0, 1), Vec3(0, 1, 0), white));
